...
// SrModuleData структура под запись EGTS_AUTH_SERVICE типа EGTS_SR_MODULE_DATA
...
//
//nolint:funlen
func (e *SrModuleData) Decode(content []byte, _ byte) error {
	var err error
...
func (e *SrModuleData) Encode(_ byte) ([]byte, error) {
	var (
		result []byte
		err    error
	)
...
func (e *SrModuleData) Length(protocolVersion byte) uint16 {
	var result uint16
